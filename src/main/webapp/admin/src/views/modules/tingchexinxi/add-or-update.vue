<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="车位编号" prop="cheweibianhao">
          <el-select  @change="cheweibianhaoChange" v-model="ruleForm.cheweibianhao" placeholder="请选择车位编号">
            <el-option
                v-for="(item,index) in cheweibianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.cheweibianhao" label="车位编号" prop="cheweibianhao">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否会员" prop="shifouhuiyuan">
          <el-select v-model="ruleForm.shifouhuiyuan" placeholder="请选择是否会员">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="入场时间" prop="ruchangshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ruchangshijian" label="入场时间" prop="ruchangshijian">
              <el-input v-model="ruleForm.ruchangshijian" 
                placeholder="入场时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="小时计费" prop="xiaoshijifei">
          <el-input v-model="ruleForm.xiaoshijifei" 
              placeholder="小时计费" clearable  :readonly="ro.xiaoshijifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="小时计费" prop="xiaoshijifei">
              <el-input v-model="ruleForm.xiaoshijifei" 
                placeholder="小时计费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="停放时长" prop="tingfangshizhang">
          <el-input v-model="ruleForm.tingfangshizhang" 
              placeholder="停放时长" clearable  :readonly="ro.tingfangshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="停放时长" prop="tingfangshizhang">
              <el-input v-model="ruleForm.tingfangshizhang" 
                placeholder="停放时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    zongjia:{
      get: function () {
        return 1*this.ruleForm.xiaoshijifei*this.ruleForm.tingfangshizhang
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ruchangshijian = true;
          ...
          if(o=='xiaoshijifei'){
            this.ruleForm.xiaoshijifei = obj[o];
	    this.ro.xiaoshijifei = true;
            continue;
          }
          if(o=='tingfangshizhang'){
            this.ruleForm.tingfangshizhang = obj[o];
	    this.ro.tingfangshizhang = true;
            continue;
          }
          if(o=='zongjia'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/cheweixinxi/cheweibianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.cheweibianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    cheweibianhaoChange () {
      this.$http({
        url: `follow/cheweixinxi/cheweibianhao?columnValue=`+ this.ruleForm.cheweibianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.quyu){
