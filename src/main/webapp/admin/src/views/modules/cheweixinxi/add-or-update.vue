    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="停放须知" prop="tingfangxuzhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="停放须知"
                  v-model="ruleForm.tingfangxuzhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tingfangxuzhi" label="停放须知" prop="tingfangxuzhi">
                    <span>{{ruleForm.tingfangxuzhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoshijifei = true;
          ...
          if(o=='tingfangxuzhi'){
            this.ruleForm.tingfangxuzhi = obj[o];
	    this.ro.tingfangxuzhi = true;
            continue;
          }
          if(o=='beizhu'){
